...
public class InputManager : MonoBehaviour
{
    ...
    [Header("Crouch Input")]
    [Tooltip("Whether or not the crouch button was pressed this frame")]
    public bool crouchPressed;
    [Tooltip("Whether or not the crouch button was held this frame")]
    public bool crouchHeld;

    /// <summary>
    /// Description:
    /// Reads and stores the crouch input
    /// Input: 
    /// CallbackContext callbackContext
    /// Return:
    /// void (no return)
    ...
    {
        crouchPressed = !context.canceled;
        crouchHeld = !context.canceled;
        StartCoroutine("ResetCrouchStart");
    }
    ...
    /// </summary>
    /// <returns>IEnumerator: Allows this to function as a coroutine</returns>
    private IEnumerator ResetCrouchStart()
    {
        yield return new WaitForEndOfFrame();
        crouchPressed = false;
    }
    ...
    {
        sprintPressed = !context.canceled;
        sprintHeld = !context.canceled;
        StartCoroutine("ResetSprintStart");
    }
    ...
    /// </summary>
    /// <returns>IEnumerator: Allows this to function as a coroutine</returns>
    private IEnumerator ResetSprintStart()
    {
        yield return new WaitForEndOfFrame();
        sprintPressed = false;
    }
